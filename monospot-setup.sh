...
cd /root/monospot
[ ! -e $PWD/monospot-setup.conf ] && { echo "\"monospot-setup.conf\" dosyasi bulunamadi, git uzerinden cekilecek..."; fetch https://raw.githubusercontent.com/monobilisim/monospot/master/monospot-setup.conf; echo "\"monospot-setup.conf\"" dosyasini editor araciligi ile duzenledikten sonra \"sh monospot-setup.sh\" komutu ile bu scripti tekrardan calistirin; exit 0; }
